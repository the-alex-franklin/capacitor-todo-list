...
import { AuthenticationKV, authenticationValidator } from "./middleware/authentication.middleware.ts";
...
user_routes.get("/me", authenticationValidator, async (c: Context<AuthenticationKV>) => {
